...
print('✅ | Press F To Turn On/Off Bring All ' .. Keybind .. '! [SessionID ' .. SessionID .. ']')
...
UserInputService.InputBegan:Connect(function(input, gameProcessedEvent)
    if input.KeyCode == Enum.KeyCode[Keybind] and not gameProcessedEvent then
        Enabled = not Enabled
        if Enabled then
            print('✅ | Enabled BigPaintball.lua [SessionID ' .. SessionID .. ']')
        else
            print('❌ | Disabled BigPaintball.lua [SessionID ' .. SessionID .. ']')
        end
    end
end)
